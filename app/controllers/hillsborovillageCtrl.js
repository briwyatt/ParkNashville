"use strict";
var google;
app.controller("hillsborovillageCtrl", function($scope, styleFactory, markerFactory, $timeout, $route) {
  ...
  var populateMarkerArray = function() {
       markerFactory.loadMarkers("hillsborovillage")
            .then((markerdata) => {
